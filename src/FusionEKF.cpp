...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  // calculate the difference and conver to seconds
  cout << "EKF: Prediction" << endl;
  double dt = (measurement_pack.timestamp_ - previous_timestamp_) / (1000.0 * 1000.0);
  previous_timestamp_ = measurement_pack.timestamp_;
  ...
  // set process covariance matrix Q using the formula from previous class
